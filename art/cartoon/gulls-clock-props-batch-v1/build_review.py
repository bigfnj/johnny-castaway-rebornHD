"""Build the 71-drawing gull, clock and prop gallery, with originals kept visible."""
import hashlib
import html
import json
...
def main():
    ...
    assert len(rows) == 71 and len({r["key"] for r in rows}) == 71
    ...
    record = {"schema_version": 1, "status": "awaiting_71_drawing_appearance_review", "generated_drawing_count": len(rows),
