...
ASSETS = [
    ("000", "halloween", "Halloween pumpkin", (80, 68), (580, 400, 1100, 752),
     "Check the pumpkin's size, carved face and contact with the sand."),
...
def main():
    ...
    pack.add_argument("--version", choices=("v1", "v2"), required=True)
    ...
    page.add_argument("--version", choices=("v1", "v2"), required=True)
