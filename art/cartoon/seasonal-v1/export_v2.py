"""Version2 seasonal placement for the current Cartoon island shoreline.
...
CONFIG = {
    0: {'scale': .14, 'canvas': [80, 68], 'raw_anchor': [631.5, 855], 'target_anchor': [39, 57.75],
        'basis': 'Native v1 overlapped water. Keep horizontal body center39HD; shrink uniformly to0.14 and raise shadow to57.75HD (scene653.75). This deliberately departs from original vertical placement for the current Cartoon shoreline.'},
    1: {'scale': .16, 'canvas': [240, 94], 'raw_anchor': [1239.5, 774], 'target_anchor': [205, 79.75],
        'basis': 'Native v1 front clovers overlapped water. Keep lowest ground patch horizontal anchor205HD; shrink uniformly to0.16 and raise it to79.75HD (scene651.75). Current Cartoon shoreline adjustment, not original geometry parity.'},
    2: {'scale': .15, 'canvas': [112, 130], 'raw_anchor': [626.5, 1046], 'target_anchor': [49.25, 117.75],
        'basis': 'Native v1 stand overlapped water. Keep star/trunk axis49.25HD; shrink uniformly to0.15 and raise shadow to117.75HD (scene651.75). Feet and shadow rise together without shape changes; this is a Cartoon shoreline placement departure.'},
