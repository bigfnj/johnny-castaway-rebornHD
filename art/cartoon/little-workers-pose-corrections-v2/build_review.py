"""Build 18 original/previous/corrected worker comparisons."""
import hashlib
import html
import json
import os
...
ROOT = HERE.parents[2]
GROUPS = {
    'gait': 'Walking progression',
    'arms': 'Arm placement and occlusion',
}
...
def main():
    ...
    review = {
        'schema_version': 1, 'status': 'awaiting_18_worker_corrections_appearance_review',
        'scope': 'Only 18 worker-pose corrections. No implied approval of other drawings.',
