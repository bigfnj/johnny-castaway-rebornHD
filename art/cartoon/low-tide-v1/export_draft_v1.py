...
CONFIG = {
    1: {'source': 'shore-raw-v2.png', 'canvas': [768,138], 'scale': .6625,
        'raw_anchor': [768,595], 'target_anchor': [384,137.5],
        'basis': 'Strip horizontal center and lower waterline. Scale stays within one percent of original guide mapping2/3; full meaningful shape is retained.'},
