"""Build the 72-drawing little-worker gallery with visible originals."""
import hashlib
import html
import json
...
def main():
    ...
    assert len(rows) == 72 and len({r["key"] for r in rows}) == 72
    ...
    record = {"schema_version": 1, "status": "awaiting_72_drawing_appearance_review", "generated_drawing_count": len(rows),
