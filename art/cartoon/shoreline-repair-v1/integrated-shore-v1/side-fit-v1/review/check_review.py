        ...
        try:
            ...
            if phase == 'smoke':
                ...
                for key, clip in manifest['cases'].items():
                    ...
                    if key == 'low_clover':
                        assert not clip['loop'], 'low tide ends mid-cycle and must stop'
                ...
                page.wait_for_function("sceneReviewState.ready&&sceneReviewState.key==='night_shift_clover'", polling=50)
                page.evaluate('selectFrame(0)')
