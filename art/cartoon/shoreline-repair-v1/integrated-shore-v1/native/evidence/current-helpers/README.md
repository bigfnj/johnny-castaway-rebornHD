...
The initial package uses the approved smooth island shape with old masked foam. Its five day still comparisons are diagnostic only: center phase 008 has no pixels with alpha at least 8. The user subsequently corrected the art direction: original waves wash over the sand and recede. New offshore drawings are comparison material, not approved replacement art. A blanket ground exclusion is not proof of correct incoming-wave behavior.
