"""Export one explicit connecting pose (009, 010, 012) at fixed family scale.

Adapted from profile-walk-v1/export.py, itself from remaining-waits-v1; approved tools stay
...
SCALE = .1
PAD = 64
TARGETS = {9: [54, .25], 10: [35, .25], 12: [39, .25]}
