...
EXPECTED_ZIP = '0748676eb6ab0685abecfeb0bbfb8547d2050e6419bb1cad5f13ccc9f716fedd'
...
def parse(folder, phase, expected):
    ...
    require('data/hd/BMP/JOHNWALK.BMP/017.png' in loaded and 'data/styles/cartoon/BMP/JOHNWALK.BMP/017.png' not in loaded,
    ...
    return {'status': 'PASS', 'phase': phase, 'island_seed': 11, 'path_seed': int(route[1]),
            ...
            'scope': 'Actual Linux production28 Cartoon walk/island and HD017 arrival. Native logical timing under maxspeed; no original-executable or wall-clock parity claim.'}
