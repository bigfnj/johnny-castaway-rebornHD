...
Acceptance recorded 2026-09-18: at this review the user said exactly "approved, continue please". This approves the appearance and isolated source-script rotation of all 14 selected TANKER.BMP views: updated 000-009 and 012, plus unchanged selected 010, 011 and 013. The exact page, selected raw PNG hashes and source sequence are bound in [acceptance/appearance-rotation-v1.json](acceptance/appearance-rotation-v1.json). This dated decision follows the historical pending-review text above; native export sizing, runtime registration, integrated scene motion and bulk integration remain pending.
