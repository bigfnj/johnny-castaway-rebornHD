"""Prepare exact visitor and thought-scene drawings and enlarged inspection copies."""
import hashlib
import io
import json
import zipfile
...
def main():
    ...
    plan = {'schema_version':1, 'target_new_drawings':COUNT, 'user_batch_default':[60,72],
            ...
            'groups':GROUPS,
            'excluded':'Johnny drawings, the clipped GJNAT1 000 entry, separate shadows and GJNAT3 aftermath are excluded. See source notes.',
