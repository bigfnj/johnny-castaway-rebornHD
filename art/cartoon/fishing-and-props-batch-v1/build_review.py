"""Build the 64-drawing fishing, props and aircraft appearance gallery, with originals kept visible."""
import hashlib
import html
import json
...
def main():
    ...
    record = {"schema_version": 1, "status": "awaiting_64_drawing_appearance_review", "generated_drawing_count": len(rows),
