"""Match the reviewed018-v2 runtime to canonical029 using pinned color functions.
...
INPUT_SHA = 'b1bf6834e30e11ccff6a4f4a66e8a0d1bd7bf3d1f5ca82eeb98d34c88b45b29f'
TARGET = [252, 148, 88]
...
def export(runtime, annotation_path, annotation_sha, output):
    ...
    recipe = {'schema_version': 1, 'operation': 'post-export-color-correction',
              'scope': 'New018-v2 proportion preview only; no production or revised-pose approval.',
