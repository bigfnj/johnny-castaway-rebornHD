"""Build five original/previous-correction/blurred-motion comparisons."""
import hashlib
import html
import json
import os
...
def main():
    ...
    for item in feedback['frames']:
        ...
        for kind, title, path in [
            ...
            ('earlier', 'Previous correction', ROOT / item['prior_raw']['path']),
            ('corrected', 'Blurred motion', output_path),
        ]:
    ...
    review = {
        'schema_version': 1, 'status': 'awaiting_five_motion_blur_refinements_appearance_review',
        'scope': 'Only five motion-blur refinements. No implied approval of other drawings.',
