"""Eight native color-review contracts: six inherited routes and two real waits."""
import hashlib
import json
...
OUT = Path('/out') if ROOT == Path('/source') else ROOT/'build/skin-tone/native-review'
...
BASELINE_SHA = '21194cf35e5b60eebfa9ba48520509ae8f86a72f26313b945f019671d1f345c5'
# Reused parser distinguishes these three connecting dependencies.
CANDIDATE_FRAMES = (9, 10, 12)
TARGET_FRAMES = tuple(range(13)) + tuple(range(15, 30))
...
CLIPS = {
    ...
    'wait015': {'label': 'Standing015: A same heading4', 'prime': [0,4,0,4], 'travel': [0,4,0,4], 'path': 'A',
                'blocks': [('arrival', [104])], 'frames': [15], 'duration_ms': 240},
    'wait016': {'label': 'Standing016: A same heading0', 'prime': [0,0,0,0], 'travel': [0,0,0,0], 'path': 'A',
                'blocks': [('arrival', [100])], 'frames': [16], 'duration_ms': 240},
}
