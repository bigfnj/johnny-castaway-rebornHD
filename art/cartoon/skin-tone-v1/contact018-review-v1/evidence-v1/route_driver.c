...
int main(int argc, char **argv)
{
    ...
    static const int prime0[4] = {3, 3, 3, 3};
    static const int travel0[4] = {3, 3, 2, 7};
    if (!strcmp(argv[3], "front_arc")) { prime = prime0; travel = travel0; }
    static const int prime1[4] = {3, 6, 3, 6};
    static const int travel1[4] = {3, 6, 4, 2};
    if (!strcmp(argv[3], "rear_arc")) { prime = prime1; travel = travel1; }
    static const int prime2[4] = {2, 1, 2, 1};
    static const int travel2[4] = {2, 1, 1, 1};
    if (!strcmp(argv[3], "travel_cb")) { prime = prime2; travel = travel2; }
    static const int prime3[4] = {4, 7, 4, 7};
    static const int travel3[4] = {4, 7, 2, 6};
    if (!strcmp(argv[3], "travel_ec")) { prime = prime3; travel = travel3; }
    static const int prime4[4] = {3, 7, 3, 7};
    static const int travel4[4] = {3, 7, 5, 3};
    if (!strcmp(argv[3], "waypoint_front")) { prime = prime4; travel = travel4; }
    static const int prime5[4] = {1, 3, 1, 3};
    static const int travel5[4] = {1, 3, 4, 5};
    if (!strcmp(argv[3], "waypoint_rear")) { prime = prime5; travel = travel5; }
    static const int prime6[4] = {0, 4, 0, 4};
    static const int travel6[4] = {0, 4, 0, 4};
    if (!strcmp(argv[3], "wait015")) { prime = prime6; travel = travel6; }
    static const int prime7[4] = {0, 0, 0, 0};
    static const int travel7[4] = {0, 0, 0, 0};
    if (!strcmp(argv[3], "wait016")) { prime = prime7; travel = travel7; }
