"""Build the 39-drawing gull and clothes appearance gallery, with originals kept visible."""
import hashlib
import html
import json
...
ROOT = HERE.parents[2]
GROUPS = [
    ("settling", "Watching, preening and settling", "GJGULL2.BMP", [2, 3, 5, *range(18, 27), 39]),
    ("carrying", "Stealing clothes and flying away", "GJGULL2.BMP", [*range(27, 34), 36, 37, 38, *range(40, 45)]),
    ("front", "Flight toward the viewer", "GJGULL2.BMP", [46, 47, 48]),
    ("props", "Clothes and bending stick", "GJGULL2.BMP", [0, 1, 4, 16, 17, 34, 35, 45]),
]
