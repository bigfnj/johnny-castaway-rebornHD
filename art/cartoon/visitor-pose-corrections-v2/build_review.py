"""Build seven original/previous/corrected visitor comparisons."""
import hashlib
import html
import json
import os
...
ROOT = HERE.parents[2]
GROUPS = {
    'camera': 'Camera and sunglasses',
    'woman': 'Belly angle and facing',
}
...
def main():
    ...
    review = {
        'schema_version': 1, 'status': 'awaiting_seven_visitor_corrections_appearance_review',
        'scope': 'Only seven visitor-pose corrections. No implied approval of other drawings.',
