...
The user approved the [18 worker pose corrections](../art/cartoon/little-workers-pose-corrections-v2/acceptance/appearance-v1.json) and requested durable lessons for subsequent packs. The [pose and action notes](art-style-learnings-pose-and-action.md) now guide per-frame source interpretation. The next [60-drawing review](../art/cartoon/workers-and-mermaids-batch-v1/README.md) contains 29 remaining unique worker poses, 22 mermaid/sandcastle drawings and 9 tail phases. SSUZY1's partial work is retained but the complete family is deferred after repeated image-tool output moderation failures. The new 60 await appearance review; native fitting and bulk verification remain deferred.
...
The user's 2026-09-20 review requested [24 focused corrections](../art/cartoon/gulls-clock-props-corrections-v2/README.md). GJGULL1A026-031 and 033-038 correct the book grip, size, page action and leg/foot occlusion. MEANWHIL013-016 correct the hand roll. GJVIS3 007-011 replace fragmented or absent propellers with connected blades and motion strokes. THEEND1 006/008/009 make empty parachutes visibly collapse with loose fabric and slack cords where present. A follow-up requested [five motion-blur refinements](../art/cartoon/propeller-motion-blur-v3/README.md): the rotating blades themselves now blur on GJVIS3 007-009 and the lower propellers of 010/011. The user approved the five selected blurred propellers with "approved, lets continue" on 2026-09-20; [exact acceptance](../art/cartoon/propeller-motion-blur-v3/acceptance/appearance-v1.json) freezes the displayed versions. Other drawings retain their prior pending status, and production remains unchanged.

The [67-drawing visitor review](../art/cartoon/visitors-and-props-batch-v1/README.md) contains 38 masked-performer poses, 14 camera/sunglasses visitor poses, 11 woman visitor gestures and four thought scenes. Shared cartoon character keys preserve identity while each original governs its pose. Upper-body pieces remain cropped as source components. Seven appearance choices are accepted below; the other 60 drawings retain their prior status. Scene fitting, multipart registration, native sequences and bulk testing remain deferred.

On 2026-09-20, the user said '012 013 014. keep your "previous cartoon". the rest approved, next batch proceed' at the [seven-pose comparison](../art/cartoon/visitor-pose-corrections-v2/README.md). The [scoped acceptance](../art/cartoon/visitor-pose-corrections-v2/acceptance/appearance-v1.json) retains the previous `visitors-and-props-batch-v1` GJNAT3 012/013/014 v1 drawings and approves corrected `visitor-pose-corrections-v2` 005/009/010/016 v1. Corrected 005 holds the camera with both hands, 009/010 have no sunglasses, and 016 faces front while looking down. The corrected 012-014 alternatives are not selected. The historical comparison and raw versions remain intact. This approval covers only those seven appearances, not the other 60 drawings or deferred native integration and testing.
