...
| --- | --- |
| Expand Cartoon by complete motion families | The accepted production pilot contains six walking poses and 15 island assets. The [production catalog](docs/knowledge-base/cartoon-production-catalog.md) now tracks all 2,401 slots and links 51 supplied-original references. The [bounded plan](docs/cartoon-production-plan.md) starts with additional walking directions; a rear-view key is approved but its complete cycle and scene still need review. Other directions, low-tide foam, other ocean/cloud variants, holiday/raft scenery and most story animations use fallback. Keep "Cartoon (preview)" until coverage is complete. Palette-driven primitives and fades require visual review beyond PNG coverage. |
