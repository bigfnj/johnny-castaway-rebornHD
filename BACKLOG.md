...
The [low-tide audit](docs/cartoon-low-tide-post-merge-audit.md) covers merged
main024c994, the61-asset delivery, fresh source review and main CI/deployment
checks. Capture-launcher diagnostics and historical replay remain tooling work.
...
| Consider seasonal prop artwork overrides | The user proposed Halloween zombie heads in place of coconuts on 2026-09-17. Existing `art_style.c` sprite paths support replacement COCONUTS.BMP drawings, but do not consult the holiday state. `story.c` selects Halloween on October 29-31 and `island.c` currently uses that state for HOLIDAY.BMP decorations. A future seasonal lookup with ordinary-art fallback could reuse this state while preserving scripted motion, registration and separate shadows. Review any coconuts painted into other sprites for visual consistency. This is a proposed feature, not implemented or added to the current art-build scope. |
| Integrate the approved ordinary sky and ocean artwork at the bulk milestone | Moving clouds BACKGRND.BMP015-017 and OCEAN02 are already delivered. The user has now visually approved [NIGHT, OCEAN00 and OCEAN01](art/cartoon/environment-v1/README.md); their exports await bulk integration with the remaining artwork. Production remains at 63 assets until that milestone. The separate CLOUDS.BMP000-003 resource has no proved runtime use in the current source/script map; investigate reachability before authoring it. Story/title SCR images remain separate work. |
...
| Continue independent props in batches of 60-72 drawings | The [coconut family](art/cartoon/coconuts-v1/README.md) has appearance approval for four orientations; its three shadow drafts, final export and native motion remain pending. The user approved all selected drawings in the [24-drawing batch](art/cartoon/props-batch-v1/README.md): BOAT000, MRAFT000-004, SANDCAST000-014 and LITEBULB000/001/004. The subsequent 37-slot ship group has scoped approvals for its 33 selected generated drawings; four SHIPS source slots remain unchanged. On 2026-09-18, "excellent, approved" accepted all 28 [FIRE1.BMP000-027 drawings](art/cartoon/fire-v1/README.md) as shown in the combined gallery and isolated phase comparison. Preserve raw outputs and scoped approvals while deferring the full test cycle. Some vehicle/story images contain Johnny or uncertain occupants; keep those with their character/scene groups. [Prop authoring lessons](docs/art-style-learnings-props.md) record shared-key generation, alpha-viewing pitfalls and original registration limits. This ordering reduces anatomy review dependencies; no production speedup was measured. |
| Integrate the approved campfire family | The user approved the [28-drawing FIRE1 review](art/cartoon/fire-v1/README.md) on 2026-09-18. [Exact acceptance](art/cartoon/fire-v1/acceptance/appearance-v1.json) binds the selected drawings and shown review. Its five isolated phase previews retain source order, draw positions and layering, with provisional uniform fitting only. Check native flame-to-log contact, all 38 dying-fire updates, clipped ember behavior and Johnny's fire-building/eating actions during bulk integration. Preserve medium phase order 009/011/010/012 and the four reversed effect/log layers. Frame 025's runtime reachability remains unproven. Original diagnostic palette and nominal port timing do not establish the original executable's display. |
| Review and integrate the food, boot and small-raft batch | The [25-drawing batch](art/cartoon/campfire-props-v1/README.md) and [13 orientation corrections](art/cartoon/campfire-props-direction-v2/README.md) remain review history. The [six annotated refinements](art/cartoon/campfire-props-bend-v3/README.md) address boot bends and squid face/head shape. The user accepted both selected [005/022 angle corrections](art/cartoon/boot-angle-v4/acceptance/appearance-v1.json) following the manual cutouts; other unmentioned frames gain no implied approval. Preserve 018 tail-only and 019 as an upside-down remaining boot piece with its connection below; static tag 72 does not establish a boot-to-boot join. FIRE5 source variants still lack native usage attribution. Fit original canvases and verify hand/mouth joins, cooking/eating order and SRAFT origins/layers at the bulk milestone. |
| Review and integrate the 42-drawing gull/nest/fish batch | [The complete GJGULL1 and LILFISH families](art/cartoon/gulls-fish-batch-v1/README.md) are the first batch under the new 36-48-drawing default. [Five fish corrections](art/cartoon/lilfish-corrections-v2/README.md) address roll, sunglasses and overlapping anatomy. The user approved the [two selected shape refinements](art/cartoon/lilfish-shape-v3/acceptance/appearance-v1.json) on2026-09-19:000's smooth crown and007's compact four-fish alternative. Original007 and its native catch still contain three fish; the variant deliberately changes the appearance count. Other unmentioned drawings await scoped appearance approval. Preserve per-pose eye/wing direction, nest stages and shadow/contact relationships. LILFISH002 uses separate tails003/004. Appearance approval is separate from source-canvas registration, native timing, assembly joins and bulk smoke/regression. |
| Review and integrate 39 shark drawings | The [39-drawing batch](art/cartoon/sharks-batch-v1/README.md) covers 26 GJFFFOOD and 13 SHARK originals. On 2026-09-19, "approved, lets start the next batch" approved only the selected [026/035 fin corrections](art/cartoon/shark-fin-corrections-v2/acceptance/appearance-v1.json): 026's gray external fin below the chin and 035's exposed swept fin above a submerged body. The other 37 drawings gain no implied approval. Preserve per-view eye visibility, rear-facing 031 and submerged dive fragments with white water. GJFFFOOD048 has no unique-slot static frame attribution. Native scale, registration, water layering, timing and bulk smoke/regression remain deferred. The next authorized batch is 39 GJGULL2 drawings of a gull stealing clothes and making a nest, excluding markers 006-015. |
| Review and integrate the 39-drawing gull and clothes batch | [GJGULL2 000-005 and 016-048](art/cartoon/gull-clothes-batch-v1/README.md) cover the bent stick, cloth bundles, preening and clothes-carrying flight. Preserve the ten 8x1 markers at 006-015 as originals. Each new pose uses its exact source for wing angle, eye visibility and cloth-to-beak attachment, with shared gull and white-cloth appearance references. On 2026-09-19, "approved, lets start on the next set" approved [ten selected corrections](art/cartoon/gull-clothes-corrections-v2/acceptance/appearance-v1.json): 037/040 and 046-048 fly away with eyes hidden, 004/034/016/045 are supported heaps with black belts, and 000 v2 has a single continuous curve. The other nine corrected selections use v1. These replace the earlier source-note interpretation; the other 29 drawings gain no implied approval. Native canvas fit, multipart joins, scene timing and bulk smoke/regression remain deferred. |
| Review and integrate the 36-drawing marine scene batch | [The marine review](art/cartoon/marine-scenes-batch-v1/README.md) contains 17 GJCATCH2 octopus poses, 12 GJDIVE animal judges and seven SPLASH effects. On 2026-09-19, the user approved [four selected corrections](art/cartoon/marine-judges-corrections-v2/acceptance/appearance-v1.json): 025 v1 restores its partly hidden far eye; gulls 027 v2 and 028/029 v1 face chest-forward with both wings holding their cards and the tail behind. The other 32 drawings gain no implied approval. Preserve blank cards for separate score overlays, per-view eye visibility and source overlaps. Original sizing, native motion and bulk smoke/regression remain deferred. |
| Review and integrate 64 fishing, prop and aircraft drawings | [This batch](art/cartoon/fishing-and-props-batch-v1/README.md) follows the user's 60-72-drawing default. The user approved [MJFISH3 008-010 unchanged v2 colors and GJBIPLAN021's hanging flag](art/cartoon/fishing-scene-and-flag-v2/acceptance/appearance-v1.json) on 2026-09-19. The other 60 drawings gain no implied appearance approval. Preserve orientation, partial silhouettes, visible eyes and multipart relationships. Native fitting, sequence timing and bulk smoke/regression remain deferred. |
| Review and integrate 71 gull, clock and prop drawings | [The batch](art/cartoon/gulls-clock-props-batch-v1/README.md) contains 26 gulls, 17 watch pieces, three sleep marks, 12 aircraft/rotor/parachute pieces, nine bottles and four water effects. The user's 2026-09-20 feedback produced [24 targeted corrections](art/cartoon/gulls-clock-props-corrections-v2/README.md): books carried in the beak and ruffled pages with the specified leg/foot occlusion, upside-down pointing hands, intact spinning propellers including the small side rotors, and collapsing empty parachutes with slack cords. Original, earlier and corrected artwork appear together. All 24 corrections await appearance review; the other 47 drawings gain no implied approval. Canvas fitting and native motion wait for bulk integration. |
| Correct two FIRE2 inventory classifications | FIRE2 010/011 are Johnny hand/grip overlays, currently labeled `not_johnny`. [Same-tag draws and original-pixel comparison](art/cartoon/fire-v1/next-batch.md) show the grip over a carried boot/fish/squid. Keep them out of the non-character prop drawing count and regenerate the inventory with this evidence during character integration. FIRE2 000/003/008 remain exact tiny markers. The saved map's reused slot 5 is ambiguous across FIRE2/FIRE3; do not infer resource identity from slot number alone. |
| Fit and join the ship-family artwork during bulk integration | The [37-slot review batch](art/cartoon/ships-batch-v1/README.md) contains 33 generated drawings plus four exact one-pixel SHIPS010-013 slots whose runtime role remains unproven. The 19 non-tanker drawings have scoped appearance approval. On 2026-09-18 the user said "approved, continue please" at the [third tanker source-sequence comparison](art/cartoon/tanker-motion-v3/README.md), approving appearance and isolated source-replay rotation for all 14 selected views: 11 updated 000-009/012 and unchanged 010/011/013. [Exact acceptance](art/cartoon/tanker-motion-v3/acceptance/appearance-rotation-v1.json) binds the shown page, PNGs and source sequence; earlier reviews and the separate bar-removal approval remain historical evidence. Native export sizing, registration, scene motion and bulk integration are still pending. SHIPS007 joins lower-hull/water003-006; GJPROW000/001 are clipped hull panels. Check joining edges, original-canvas fit, tanker yaw continuity, water phase colors and native effect timing together. Existing SHIPS static mapping has 200 ambiguous draw sites and no unique-slot attribution for000-002/019-020. Do not equate complete-family PNG coverage with executed scene coverage. |
| Expand Cartoon by complete motion families | Production contains63 assets:28 Johnny poses,31 island/environment assets and four seasonal decorations. The [production catalog](docs/knowledge-base/cartoon-production-catalog.md) tracks all2,401 slots and supplied-original references. Front024-029, rear011/019-023 and profile001-008 are delivered, as are standing000/015/016/017/018 and ordinary connecting009/010/012. The [connecting delivery](docs/cartoon-connecting-poses-verification.md) includes the accepted lighter skin palette and corrected018 foot contact. Other scenery states, rafts and most story animations still use fallback. Keep "Cartoon (preview)" until coverage is complete; PNG coverage does not review palette primitives, fades or every story interaction. |
...
| Record process identity when capture isolation fails | The low-tide post-merge local gate stopped at `gate-child-became-foreground` during Python approval-history regression, after native renderer checks. The input-desktop check passed. The launcher compares the foreground PID with every descendant PID previously observed, but did not retain the failing PID or its creation time. This cannot distinguish a real child-window event from PID reuse. Preserve identity and window evidence at failure before choosing a fix; the merged-main four-platform CI passed. See the [low-tide audit](docs/cartoon-low-tide-post-merge-audit.md). |
...
| Share exporter and native-review configuration for later families | The017 and016 authoring checkpoints preserve the same premultiplied filtering with different source hashes, cap targets and canvases. A copied native adapter initially retained a017 metadata label while packaging016; comparison checks rejected it before review. The new000/015 shared exporter requires an explicit frame and recipe match, with historical-filter parity and executed mutation checks. Future native review should likewise make frame identity, registration, route and baseline-package inputs explicit shared configuration. The low-tide native adapter pins the pre-promotion archive and must run in its historical snapshot; current delivery documentation now states this. Preserve historical exporters/recipes and their exact bytes; verify new common tooling against their outputs instead of rewriting accepted evidence. This is a maintenance opportunity, not a measured speedup. |
