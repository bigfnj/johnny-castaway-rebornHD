...
| Finish Cartoon shoreline enlargement before more ground props | The [matched original comparison](art/cartoon/seasonal-v1/island-footprint-v1/README.md) proves that original wave003-011 sprites supply opaque sand beyond base000. Cartoon prompts removed it, causing up to13 HD pixels of local ground retreat in the captured phase. [Shoreline repair](art/cartoon/shoreline-repair-v1/README.md) restores full-size props and a continuous ground master. User-marked remaining spots exposed old foam over new sand plus two clover contact pads straddling the coast. [Contact refinement](art/cartoon/shoreline-repair-v1/foam-contact-v2/README.md) separates the foam visibility correction from a small generated ground extension beneath those pads. Human scene approval and production integration remain pending. Before promotion, review all wave phases, low tide, shifted/night scenes and approved Johnny standing/walking contacts. Preserve original origins and full-size props. This lower-wave finding alone does not explain the earlier upper-shore018 issue. |
