...
| Continue independent props after the environment group | The [coconut family](art/cartoon/coconuts-v1/README.md) now has four orientation drafts and three separate shadow drafts awaiting visual approval; final export and native motion remain pending. The [seasonal delivery](docs/cartoon-seasonal-verification.md) integrates the approved island, clean offshore waves and all four HOLIDAY.BMP decorations, including the inset banner. Keep the incoming-wash alternative as an unselected reference. Follow independent props with vehicle directions. Some vehicle/story images contain Johnny or uncertain occupants; keep those with their character/scene groups. This ordering reduces anatomy review dependencies; no production speedup was measured. |
