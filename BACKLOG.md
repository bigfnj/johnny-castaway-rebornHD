...
| Review and integrate the 39-drawing gull and clothes batch | [GJGULL2 000-005 and 016-048](art/cartoon/gull-clothes-batch-v1/README.md) cover the bent stick, cloth bundles, preening and clothes-carrying flight. Preserve the ten 8x1 markers at 006-015 as originals. Each new pose uses its exact source for wing angle, eye visibility and cloth-to-beak attachment, with shared gull and white-cloth appearance references. The user requested [ten corrections](art/cartoon/gull-clothes-corrections-v2/README.md): 037/040 and 046-048 fly away with eyes hidden, 004/034/016/045 are grounded heaps with black belts, and 000 needs a single continuous curve. Those instructions supersede the earlier source-note interpretation. Corrected appearance review is pending; native canvas fit, multipart joins, scene timing and bulk smoke/regression remain deferred. |
