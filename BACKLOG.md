...
| Review and integrate 64 fishing, prop and aircraft drawings | [This batch](art/cartoon/fishing-and-props-batch-v1/README.md) follows the user's increased 60-72-drawing default: 42 catches, planks, lifebelts, rods, fins and water effects, plus 22 aircraft, flag and associated effect drawings. The [targeted fishing-scene and flag review](art/cartoon/fishing-scene-and-flag-v2/README.md) shows MJFISH3 008-010 in context before deciding their colors and corrects GJBIPLAN 021 to a long flag hanging freely from the top. Cartoon fish colors remain unchanged. Preserve per-frame orientation, partial silhouettes, visible eyes and multipart relationships. Appearance review is pending; native fitting of the Cartoon assets, sequence timing and bulk smoke/regression remain deferred. |
