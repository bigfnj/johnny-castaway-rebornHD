...
| --- | --- |
| Expand Cartoon by complete motion families | Production contains32 assets:12 walking poses,5 standing views covering all8 directions, and15 island assets. The [production catalog](docs/knowledge-base/cartoon-production-catalog.md) tracks all2,401 slots and links51 supplied-original references. The [complete front walk024-029](docs/cartoon-front-refresh-verification.md) remains intact; the latest front refresh replaced028/029 while retaining024-027, with all6 reviewed across23 walking positions. The [standing-family delivery](docs/cartoon-standing-verification.md) adds approved000/015/016/017 alongside018, with native arrival, both front turns and complete direction-ring reviews. Ordinary003/009/010/012 remain HD and are deferred to the profile-walk/context batch below. The [rear delivery record](docs/rear-cartoon-walk-verification.md) preserves direction-table and story uses. Other directions, low-tide foam, other ocean/cloud variants, holiday/raft scenery and most story animations use fallback. Keep "Cartoon (preview)" until coverage is complete. Palette-driven primitives and fades require visual review beyond PNG coverage. |
| Review the complete profile walk before ordinary turn003 | The [original-only dependency summary](art/cartoon/walk-pilot/front-arrival-v1/ordinary-turns-v1/reference/dependency-summary.json) finds003 in19 route-table rows across11 groups and12 turn rows; A-to-C and C-to-A cycles repeat2-to3-to4. Promoting003 alone would mix Cartoon into HD walking001-008. Next review that complete profile cycle, then ordinary009/010/012 with its shared contexts.009 connects profile003 to approved front024-029;010/012 occur in compiled departure/waypoint paths despite having no direct route-table rows. Static TTM sites are recorded separately:003=37,009=5,010=8,012=2. Original references are prepared; no new ordinary art is generated or approved. |
