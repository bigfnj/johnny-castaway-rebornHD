...
| Finish Cartoon shoreline enlargement before more ground props | The [matched original comparison](art/cartoon/seasonal-v1/island-footprint-v1/README.md) proves that original wave003-011 sprites supply opaque sand beyond base000. Cartoon prompts removed it, causing up to13 HD pixels of local ground retreat in the captured phase. The user requested restoring that footprint and the props' original size. [Shoreline repair](art/cartoon/shoreline-repair-v1/README.md) restores V1 prop registration with the approved pumpkin. Separate sand strips passed technical capture but were rejected for visible seams; a continuous ground master now supplies the shared surface. Human scene approval and production integration remain pending. Before promotion, review all wave phases, low tide, shifted/night scenes and approved Johnny standing/walking contacts. Preserve original origins and full-size props. This lower-wave finding alone does not explain the earlier upper-shore018 issue. |
