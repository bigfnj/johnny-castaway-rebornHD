...
| --- | --- |
| Style the remaining sky and ocean states | The [low-tide delivery](docs/cartoon-low-tide-verification.md) completes BACKGRND.BMP001/002 and030-041 as one approved scene group. Ordinary moving clouds are BACKGRND.BMP015-017: 015 is approved, and 016/017 are being prepared for human review in [clouds-v1](art/cartoon/clouds-v1/README.md). The separate CLOUDS.BMP000-003 resource has no proved runtime use in the current source/script map; investigate reachability before authoring it. NIGHT.SCR and alternate ocean screens beyond OCEAN02 still use fallback. Review night/ocean states as coherent scenes, retaining both accepted tide compositions. Keep Cartoon labeled as a partial preview. |
