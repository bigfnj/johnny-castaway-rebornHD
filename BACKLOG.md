...
| Review and integrate 64 fishing, prop and aircraft drawings | [This batch](art/cartoon/fishing-and-props-batch-v1/README.md) follows the user's increased 60-72-drawing default: 42 catches, planks, lifebelts, rods, fins and water effects, plus 22 aircraft, flag and associated effect drawings. Preserve per-frame orientation, partial silhouettes, visible eyes and multipart relationships. Exact originals remain beside all new drawings. Appearance review is pending; native fitting, sequence timing and bulk smoke/regression remain deferred. |
