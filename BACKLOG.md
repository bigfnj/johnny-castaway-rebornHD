...
| Review and integrate the food, boot and small-raft batch | The user rejected 13 orientation/eye interpretations in the [25-drawing batch](art/cartoon/campfire-props-v1/README.md). [The correction review](art/cartoon/campfire-props-direction-v2/README.md) covers upside-down fish012/013/014, boot005/009/015/019/022 directions and all five squid eye/gaze views. The other12 remain unchanged without implied approval. Preserve018 tail-only and019 as an upside-down remaining boot piece with its connection below; static tag72 does not establish a boot-to-boot join. FIRE5 source variants still lack native usage attribution. Fit original canvases and verify hand/mouth joins, cooking/eating order and SRAFT origins/layers at the bulk milestone. |
