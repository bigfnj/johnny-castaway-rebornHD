...
| Finish Cartoon shoreline enlargement before more ground props | The user approved the [two-inlet sand shape](art/cartoon/shoreline-repair-v1/smooth-shore-v3/README.md). The [three-way clover comparison](art/cartoon/shoreline-repair-v1/integrated-shore-v1/wave-approaches-v1/README.md) now compares original source animation, offshore ripples and water washing onto sand. Both Cartoon variants retain identical approved ground, full-size V5 clovers and side waves. Center-wave motion remains pending human review. Original waves include water covering sand, so blanket ground-exclusion masking is unsuitable for the incoming approach. Named Cartoon canvas extents preserve logical positions without shrinking or clipping art. After the center decision, finish the side-wave behavior and check all seasonal props, low tide, shifted/night scenes and approved Johnny contacts before production. The earlier upper-shore 018 issue remains a separate contact observation. |
