...
| Review standalone seasonal drafts before resuming character production | HOLIDAY.BMP000-003 drafts (pumpkin, clover, decorated tree and New Year banner) are prepared in [seasonal-v1](art/cartoon/seasonal-v1/README.md), pending human scene approval and production integration. Original ground registration put three drafts at the Cartoon water edge; the revised export adjusts uniform scale and contact inside the unchanged canvases. Follow with independent props, then vehicle directions and environmental animation. Some vehicle/story images contain Johnny or uncertain occupants; keep those with their character/scene groups. This ordering reduces anatomy review dependencies; no production speedup was measured. |
