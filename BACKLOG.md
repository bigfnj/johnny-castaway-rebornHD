...
| Review and integrate the 42-drawing gull/nest/fish batch | [The complete GJGULL1 and LILFISH families](art/cartoon/gulls-fish-batch-v1/README.md) are the first batch under the new36-48-drawing default. Preserve per-pose eye/wing direction, nest stages and shadow/contact relationships. LILFISH002 uses separate tails003/004;006/007/008 contain two/three/four fish. Appearance approval is separate from source-canvas registration, native timing, assembly joins and bulk smoke/regression. |
