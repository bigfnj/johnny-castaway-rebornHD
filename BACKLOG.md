...
| Review and integrate 71 gull, clock and prop drawings | [The next batch](art/cartoon/gulls-clock-props-batch-v1/README.md) contains 26 gulls, 17 watch pieces, three sleep marks, 12 aircraft/rotor/parachute pieces, nine bottles and four water effects. Exact originals accompany every drawing. Rear gull eye visibility, pointing-arm bends, propeller phases and empty parachute silhouettes remain explicit review concerns. Appearance approval is pending; canvas fitting and native motion wait for bulk integration. |
