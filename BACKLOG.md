...
| --- | --- |
| Expand Cartoon by complete motion families | Production contains 12 walking poses, standing arrival 018 and 15 island assets. The [production catalog](docs/knowledge-base/cartoon-production-catalog.md) tracks all 2,401 slots and links 51 supplied-original references. The rear cycle, arrival 018 and [complete six-drawing front walk 024-029](docs/cartoon-front-refresh-verification.md) have native island approvals. The latest front pass replaces 028/029 while retaining the earlier Cartoon drawings 024-027; all six were reviewed together across 23 walking positions. The [next family plan](docs/cartoon-front-arrival-plan.md) now has a completed original/C trace. Standing017 appearance and its front-walk arrival are accepted;016 and both front waiting turns are also accepted;000/015 are the current standing-direction review work. Neither new asset is promoted yet, so eight of ten unique wait/turn-table slots remain HD in production. The [rear delivery record](docs/rear-cartoon-walk-verification.md) preserves direction-table and story uses. Other directions, low-tide foam, other ocean/cloud variants, holiday/raft scenery and most story animations use fallback. Keep "Cartoon (preview)" until coverage is complete. Palette-driven primitives and fades require visual review beyond PNG coverage. |
| Review017 story uses separately from its arrival | The [wait/turn trace](art/cartoon/walk-pilot/front-arrival-v1/trace/trace.json) identifies31 static017 draws across eight TTM resources, including17 in SJLEAVES. The accepted E-to-A arrival does not review those story interactions. Exercise relevant story placements and contacts before claiming complete017 scene coverage; preserve the original-versus-port SJLEAVES delay distinction. |
