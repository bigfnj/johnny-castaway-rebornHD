...
| Review and integrate the 42-drawing gull/nest/fish batch | [The complete GJGULL1 and LILFISH families](art/cartoon/gulls-fish-batch-v1/README.md) are the first batch under the new 36-48-drawing default. [Five fish corrections](art/cartoon/lilfish-corrections-v2/README.md) address 000/001 roll and mouth count, sunglasses in006/007, and008's independent fish bodies. The far-right shape in007/008 is a tail. These corrections and the other unmentioned drawings still await scoped appearance approval. Preserve per-pose eye/wing direction, nest stages and shadow/contact relationships. LILFISH002 uses separate tails003/004;006/007/008 contain two/three/four fish. Appearance approval is separate from source-canvas registration, native timing, assembly joins and bulk smoke/regression. |
