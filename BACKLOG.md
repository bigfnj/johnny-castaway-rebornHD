...
| Start standalone non-Johnny batches before resuming character production | Recommended next group is HOLIDAY.BMP000-003: pumpkin, clover, decorated tree and New Year banner. Follow with independent props, then vehicle directions and environmental animation. Some vehicle/story images contain Johnny or uncertain occupants; keep those with their character/scene groups. This ordering reduces anatomy review dependencies; no production speedup was measured. |
