...
| Review and integrate the food, boot and small-raft batch | [25 new drawings](art/cartoon/campfire-props-v1/README.md) await appearance approval: FIRE2/FIRE5 fish, boots and squid plus SRAFT raft/paddle. Preserve FIRE2 018 tail-only and 019 toe-only. FIRE5 000/001 mirror FIRE2 024/023 in original visible pixels; generated reflections are visual drafts, not exact-pixel claims. FIRE5's native scene usage remains unattributed. Fit original canvases and verify hand/mouth joins, cooking/eating order and SRAFT origins/layers at the bulk milestone. |
