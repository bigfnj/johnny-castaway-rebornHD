...
| Fit and join the ship-family artwork during bulk integration | The [37-slot review batch](art/cartoon/ships-batch-v1/README.md) contains33 generated drafts plus four exact one-pixel SHIPS010-013 slots whose runtime role remains unproven. SHIPS007 joins lower-hull/water003-006; GJPROW000/001 are clipped hull panels. Check joining edges, original-canvas fit, tanker yaw continuity, water phase colors and native effect timing together. Existing SHIPS static mapping has200 ambiguous draw sites and no unique-slot attribution for000-002/019-020. Do not equate complete-family PNG coverage with executed scene coverage. The [next art group](art/cartoon/ships-batch-v1/next-batch.md) is all28 FIRE1 frames. |
