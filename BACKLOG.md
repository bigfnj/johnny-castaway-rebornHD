...
| Review and integrate the 36-drawing marine scene batch | [The marine review](art/cartoon/marine-scenes-batch-v1/README.md) contains 17 GJCATCH2 octopus poses, 12 GJDIVE animal judges and seven SPLASH effects. Starfish, crab, round fish and gull each retain their own card-holding phases. Preserve blank cards for separate score overlays, per-view eye visibility and source overlaps. All are new appearance drafts; original sizing, native motion and bulk smoke/regression remain deferred. |
