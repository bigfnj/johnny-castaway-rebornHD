...
| Finish Cartoon shoreline enlargement before more ground props | The user approved the [two-inlet sand shape](art/cartoon/shoreline-repair-v1/smooth-shore-v3/README.md) and chose [Cartoon: offshore ripples](art/cartoon/shoreline-repair-v1/integrated-shore-v1/wave-approaches-v1/selection.json) after the three-way clover comparison. Keep the incoming-wash alternative as an unselected reference. The selected version passed 24 native smoke captures, then 24 fresh repeats and six negative controls. The enlarged ground hid substantial portions of the older side-wave drawings, so [side-fit-v1](art/cartoon/shoreline-repair-v1/integrated-shore-v1/side-fit-v1/request.json) repositions their complete unmasked sources without shrinking them. A separate [007 shading correction](art/cartoon/shoreline-repair-v1/integrated-shore-v1/foam-shading-v1/README.md) removes the dark band explicitly identified by the user. Review those combined changes in native motion before production integration. Named Cartoon canvas extents preserve logical positions and complete artwork. The earlier upper-shore 018 observation remains separate from this lower-shore correction. |
| Integrate reviewed seasonal art before resuming character production | HOLIDAY.BMP000-003 drafts (pumpkin, clover, decorated tree and New Year banner) are prepared in [seasonal-v1](art/cartoon/seasonal-v1/README.md). The pumpkin's red eyes, sharp evil grin, slight rot and placement are approved; Christmas tree placement is also accepted. The user approved the [inset banner](art/cartoon/seasonal-v1/banner-inset-v1/selection.json), whose cloth corners meet the existing fronds. Use its V2 export, which corrects recipe line-ending provenance and reproduces the exact reviewed PNG. Other decorations retain V5 size and registration. Finish the pending wave-motion review before integrating the combined island and seasonal package. Follow with independent props, then vehicle directions and environmental animation. Some vehicle/story images contain Johnny or uncertain occupants; keep those with their character/scene groups. This ordering reduces anatomy review dependencies; no production speedup was measured. |
