...
| Review and integrate 39 shark drawings | The [next 39-drawing batch](art/cartoon/sharks-batch-v1/README.md) covers 26 GJFFFOOD and 13 SHARK originals, with source poses and shared gray-shark styling. Appearance review is pending. Preserve per-view eye visibility, mouth/tongue changes, rear-facing031 and submerged dive fragments with attached white water. GJFFFOOD048 has no unique-slot static frame attribution. Native scale, registration, water layering, timing and bulk smoke/regression remain deferred. The next scouted candidate is 39 GJGULL2 drawings of a gull stealing clothes and making a nest, excluding markers006-015. |
