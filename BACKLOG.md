...
| Review and integrate 39 shark drawings | The [39-drawing batch](art/cartoon/sharks-batch-v1/README.md) covers 26 GJFFFOOD and 13 SHARK originals. The user's [026/035 corrections](art/cartoon/shark-fin-corrections-v2/README.md) identify026's projection as a fin rather than a tongue, and035 as a mostly submerged body with an exposed fin. Corrected appearance review is pending; unmentioned frames gain no implied approval. Preserve per-view eye visibility, rear-facing031 and submerged dive fragments with white water. GJFFFOOD048 has no unique-slot static frame attribution. Native scale, registration, water layering, timing and bulk smoke/regression remain deferred. The next scouted candidate is 39 GJGULL2 drawings of a gull stealing clothes and making a nest, excluding markers006-015. |
